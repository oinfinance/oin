...
contract FrontStake is Owned, WhiteList {
    ...
    IERC20 token;
     ...
     address [5] tokens = [0x1CFC820F300103fC58a8804c221846fD25eC32D5,0x188407eeD7B1bb203dEd6801875C0B5Cb1027053,0x1CFC820F300103fC58a8804c221846fD25eC32D5,0x1CFC820F300103fC58a8804c221846fD25eC32D5,0x1CFC820F300103fC58a8804c221846fD25eC32D5];
    ...
    function stake(uint256 coinAmount) external notClosed {
        ...
        require(params.isNormal(orcl.val()), "FRONT's price is too low.");
    ...
    function injectReward(uint256 amount) external onlyOwner {
        tokzen.transferFrom(msg.sender, address(this), amount);
